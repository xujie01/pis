...
import com.pis.upms.dao.mapper.*;
import com.pis.upms.dao.model.*;
import com.pis.upms.rpc.api.UpmsApiService;
import com.pis.upms.rpc.mapper.UpmsApiMapper;
...
public class UpmsApiServiceImpl implements UpmsApiService {
     ...
     */
    @Override
    @Cacheable(value = "pis-upms-rpc-service-ehcache", key = "'selectUpmsPermissionByUpmsUserId_' + #upmsUserId")
     ...
     */
    @Override
    @Cacheable(value = "pis-upms-rpc-service-ehcache", key = "'selectUpmsRoleByUpmsUserId_' + #upmsUserId")
